 ...
 * 在Mock体系中属于执行器的范围
 */
public abstract class AbstractComplexRandom implements ComplexRandomType {
    public static Logger LOG = LoggerFactory.getLogger(AbstractComplexRandom.class);
     ...
     * @return
     */
    public abstract Object compute(Field declaredField, Rule rule,MockContext context );
