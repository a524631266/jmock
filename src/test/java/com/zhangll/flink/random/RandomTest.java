...
public class RandomTest {
    ...
    public static String doubleSurName[] = {"万俟","司马","上官","欧阳","夏侯","诸葛","闻人","东方",
            ...
            "梁丘","左丘","东门","西门","南宫"};
    public static String[] word = {"一","乙","二","十","丁","厂","七","卜","人","入","八","九","几","儿","了","力","乃","刀","又",
    ...
    public void testChar(){
        char random = CharRandom.random();
        System.out.println(random);
    }

    @Test
    public void testString(){
//        String random = StringRandom.random();
//        System.out.println(random);
        for (int i = 0; i < 100; i++) {
    ...
    public void test(){
        for (int i = 0; i < surName.length; i++) {
            char[] chars = surName[i].toCharArray();
